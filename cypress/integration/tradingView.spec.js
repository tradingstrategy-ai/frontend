describe('Traging strategy Trading View', () => {
  before(() => {
  ...
  it('Check links are correct', () => {
    cy.get('[data-testid=link-blockchains]')
      .invoke('attr', 'href')
      .should('eq', '/trading-view/blockchains')

    cy.get('[data-testid=link-exchanges ]')
      .invoke('attr', 'href')
      .should('eq', '/trading-view/exchanges')

    cy.get('[data-testid=link-tradingpairs]')
      .invoke('attr', 'href')
      .should('eq', '/trading-view/trading-pairs')

    cy.get('[data-testid=link-backtesting]')
      .invoke('attr', 'href')
      .should('eq', '/trading-view/backtesting')
