describe('Trading strategy Community', () => {
	...
	it('Check links are correct', () => {
		cy.get('[data-testid=link-blog]').invoke('attr', 'href').should('eq', '/blog');

		cy.get('[data-testid=link-twitter]').invoke('attr', 'href').should('eq', 'https://twitter.com/TradingProtocol');

		cy.get('[data-testid=link-telegram]').invoke('attr', 'href').should('eq', 'https://t.me/trading_protocol');
		...
		cy.get('[data-testid=link-github]').invoke('attr', 'href').should('eq', 'https://github.com/tradingstrategy-ai/');
