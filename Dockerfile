...
# server.js imports static-cache-control.js at runtime; keep the two in step
COPY --from=builder /app/scripts/server.js ./scripts/server.js
COPY --from=builder /app/scripts/static-cache-control.js ./scripts/static-cache-control.js
