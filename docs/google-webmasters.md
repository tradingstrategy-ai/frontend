...
| Font layout shift                              | Metric-matched fallback faces in `static/fonts/fonts6.css` (see `docs/speed.md`); `src/lib/server/font-preload.ts` sends the `Link` preload headers on HTML responses only.                                                                                                                                                                           |
