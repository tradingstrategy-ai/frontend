...
The multi-vault comparison chart derives its Net curve in the browser because the parquet contains only share-price history, not historical investor balances or fee crystallisation events. It treats the first visible value as starting capital, deducts entry fees, accrues externalised management fees against that fixed invested capital, applies externalised performance fees to positive profit after management fees at each point, and deducts exit fees at the final visible point. The balance is floored at zero. Entry and exit deductions are plotted as boundary dips. This is a hypothetical point-in-time liquidation value, not an exact reconstruction of high-water marks, evolving assets under management, or past crystallisation events. Internalised management and performance fees are not deducted again because they are already reflected in the share price.
