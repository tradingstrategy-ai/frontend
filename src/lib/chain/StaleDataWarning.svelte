...
{#if chainSlugs.includes('polygon') || allChains}
	<div class="alert alert-danger">
		<a href="/trading-view/polygon">Polygon blockchain</a> data is being processed at the moment. Real-time and historical
		prices may not be available at the moment.
	</div>
{/if}
