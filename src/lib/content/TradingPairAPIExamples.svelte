...
<p>
	Download daily <a class="body-link" href="https://tradingstrategy.ai/docs/glossary.html#term-OHLCV">OHLCV</a> candles as
	JSON over HTTP GET.
</p>
...
<p>
	Backtesting datasets are available as a separate download. The datasets include <strong>{summary.pair_symbol}</strong>
	data. View <a class="body-link" href="/trading-view/backtesting">backtesting datasets</a>.
</p>
