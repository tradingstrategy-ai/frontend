...
export const runStateSchema = z.object({
	...
	completed_cycle: count.nullish(),
	cycles: count.nullish(),
	position_trigger_checks: count.nullish(),
	position_revaluations: count.nullish(),
	frozen_positions: count.nullish(),
