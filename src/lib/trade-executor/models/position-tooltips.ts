...
export const positionTooltips = {
	...
	currentValue: 'Latest estimated realisable value based on current liquidity and market depth.',
	nominalValue: 'Current value of position (price ✕ quantity) if sold at unobtainable theoretical price.',
