			...
			<Nav class="ms-auto" navbar>
				<Dropdown nav inNavbar>
					<DropdownToggle nav caret
						>Market data <span class="fas fa-angle-down nav-link-arrow ml-2" /></DropdownToggle
					>
					<DropdownMenu end>
						<DropdownItem disabled
							>Blockchains <span class="badge text-uppercase">Soon</span></DropdownItem
						>
						<DropdownItem disabled
							>Exchanges <span class="badge text-uppercase">Soon</span></DropdownItem
						>
						<DropdownItem disabled
							>Trading pairs <span class="badge text-uppercase">Soon</span></DropdownItem
						>
						<DropdownItem divider />
						<DropdownItem rel="external" href="https://tradingstrategy.ai/api/explorer/"
							>Real-time API</DropdownItem
						>
				...
				<Dropdown nav inNavbar>
					<DropdownToggle nav caret
						>Protocol <span class="fas fa-angle-down nav-link-arrow ml-2" /></DropdownToggle
					>
					<DropdownMenu end>
						<DropdownItem disabled
							>About <span class="badge text-uppercase">Soon</span></DropdownItem
						>
						<DropdownItem rel="external" href="https://tradingstrategy.ai/docs/index.html"
							>Documentation</DropdownItem
						>
						<DropdownItem
							rel="external"
							href="https://tradingstrategy.ai/docs/protocol/comparison.html"
				...
				<Dropdown nav inNavbar>
					<DropdownToggle nav caret
						>Community <span class="fas fa-angle-down nav-link-arrow ml-2" /></DropdownToggle
					>
					<DropdownMenu end>
						<DropdownItem disabled>Blog <span class="badge text-uppercase">Soon</span></DropdownItem
						>
						<DropdownItem rel="external" href="https://github.com/tradingstrategy-ai/"
							>Github repository</DropdownItem
						>
						<DropdownItem rel="external" href="https://discord.gg/yReMpKykaS"
							>Discord chat</DropdownItem
						>
					</DropdownMenu>
				</Dropdown>
			</Nav>
