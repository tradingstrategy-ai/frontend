	...
	<section class="md-12">
		<div class="card">
			<div class="card-body">
				...
				<p>
					The following on-chain trade and liquidity datasets are available for decentralised
					finance (DeFi) research, cryptocurrency algorithmic trading, automated trading strategy
					research and execution.
				</p>

				<p>
					You can download the datasets with an API key. Request an API key via Telegram or <a
						href="https://tradingstrategy.ai/docs/">Python client registration.</a
					>
				</p>
				...
				<p>
					...
					<a href="https://tradingstrategy.ai/docs/glossary.html#term-AMM"
						>automatic market maker (AMM)</a
					>
					exchanges. The supported blockchains include popular Ethereum, Binance Smart Chain
					<span class="badge text-uppercase">Coming soon</span>, Polygon
				...
				<p>
					Datasets are distributed in <a href="https://parquet.apache.org/">Parquet</a> file format designed
					for data research. Parquet is a columnar data format for high performance in-memory datasets
					from Apache Arrow project.
				</p>

				<p>
					Datasets are large. Datasets are compressed using Parquet built-in Snappy compression and
					may be considerably larger when expanded to RAM. We expect you to download the dataset,
					cache the resulting file on a local disk and perform your own strategy specific trading
					pair filtering before using the data. Uncompressed one minute candle data takes several
					gigabyte of memory.
				</p>
