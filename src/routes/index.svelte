		...
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					...
					<p class="lead">
						<span class="pulse" /> Currently running <strong>1</strong> oracle nodes, connected to
						<strong>1</strong>
						blockchains, <strong>264</strong> decentralised exchanges with <strong>57,359</strong>
						trading pairs and <strong>48,863</strong> tokens. Automated trading strategies make
						decisions based on <strong>181 GB</strong> oracle data.
					</p>
				</div>
			</div>
		</div>
			...
			<div class="row">
				...
				<div class="col-md-12">
					<p>
						...
						•
						<a class="body-link" href="mailto:info@tradingstrategy.ai"
							>Contact for business inquiries</a
						>
					</p>
				</div>
			</div>
